...
import ng.i.sav.bot.qdroid.model.*
import java.io.File
...
interface BotApi {
     ...
     * @return [Guild]
     * */
    fun getGuilds(guildId: String): ng.i.sav.bot.qdroid.model.Guild
     ...
     * @return [Member] 数组
     */
    fun getGuildsMembers(guildId: String, after: String = "0", limit: Int = 1): List<ng.i.sav.bot.qdroid.model.Member>
    ...
    fun getGuildsMembersRoles(
        ...
        startIndex: String = "0",
        limit: Int = 1
    ): ng.i.sav.bot.qdroid.model.RolesResp

    /**
     * 获取成员详情
     * @return [Member]
     * */
    fun getGuildsMember(guildId: String, userId: String): ng.i.sav.bot.qdroid.model.Member
     ...
     * @return [PinsMessage]
     * */
    fun addChannelsPins(channelId: String, messageId: String): ng.i.sav.bot.qdroid.model.PinsMessage
     ...
     *
     * */
    fun getChannelsPins(channelId: String): ng.i.sav.bot.qdroid.model.PinsMessage
